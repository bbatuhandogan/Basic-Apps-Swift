...
struct StoryBrain {
    ...
    lazy var currentStory: Story = stories[0]
    
    mutating func setCurrentStory() {
    ...
    mutating func setNextStory(choice: String) {
        if choice == currentStory.choice1 {
            nextStory = currentStory.choice1Destination
            setCurrentStory()
        } else {
            nextStory = currentStory.choice2Destination
            setCurrentStory()
        }
    }
}
